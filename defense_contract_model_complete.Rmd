...
CompleteContracts <-read.csv(
    paste("LargeDataSets\\defense_contract_SP_ContractSampleCriteriaDetailsCustomer.csv",sep=""),
...
#Limit to completed contracts that start in 2000 or later.
...
#Is this redundant?
#LargeDataSets\\Defense_Contract_SP_ContractDetailsCustomer.csv

CompleteContracts<-read_and_join(""
                                 ,"Defense_Contract_SP_ContractDetailsCustomer.csv"
                                 ,CompleteContracts
                                 ,"LargeDataSets\\"
                                 ,by="CSIScontractID"
...
CompleteContracts<-CompleteContracts[,!colnames(CompleteContracts) %in% c(
#     Action.Obligation,
#     MinOfSignedDate,
...
```{r Outcome}
#"LargeDataSets\\Defense_contract_SP_ContractUnmodifiedandOutcomeDetailsCustomer.csv"

CompleteContracts<-read_and_join("",                                 "Defense_contract_SP_ContractUnmodifiedandOutcomeDetailsCustomer.csv"
                                 ,CompleteContracts
                                 ,"LargeDataSets\\"
                                 ,by="CSIScontractID"
                                 ,NewColumnsTrump=FALSE
...
CompleteContracts$UnmodifiedDays[CompleteContracts$UnmodifiedDays<0]<-NA
CompleteContracts$qDuration<-cut2(CompleteContracts$UnmodifiedDays,cuts=c(61,214,366,732))


#Categorize the size of the original ceiling
...
CompleteContracts$pChangeOrderUnmodifiedBaseAndAll<-
    CompleteContracts$ChangeOrderBaseAndAllOptionsValue/
    CompleteContracts$UnmodifiedContractBaseAndAllOptionsValue
CompleteContracts$pChangeOrderUnmodifiedBaseAndAll[
    is.na(CompleteContracts$pChangeOrderUnmodifiedBaseAndAll)&
        CompleteContracts$SumOfisChangeOrder==0]<-0
...
#Percent New Work
CompleteContracts$pNewWorkObligated<-CompleteContracts$NewWorkObligatedAmount/
    CompleteContracts$Action.Obligation
CompleteContracts$pNewWorkObligated[is.na(CompleteContracts$pNewWorkObligated)&
                                            CompleteContracts$SumOfisNewWork==0]<-0
CompleteContracts$pNewWorkUnmodifiedBaseAndAll<-
    CompleteContracts$NewWorkBaseAndAllOptionsValue/
    CompleteContracts$UnmodifiedContractBaseAndAllOptionsValue
CompleteContracts$pNewWorkUnmodifiedBaseAndAll[
    is.na(CompleteContracts$pNewWorkUnmodifiedBaseAndAll)&
        CompleteContracts$SumOfisNewWork==0]<-0
...
```{r BucketPlatform}
#LargeDataSets\\defense_contract_SP_ContractBucketPlatformCustomer.csv
CompleteContracts<-read_and_join(""
...
#LargeDataSets\\defense_contract_SP_ContractUnmodifiedCompetitionvehicleCustomer.csv
CompleteContracts<-read_and_join(""
...
if (all(levels(CompleteContracts$qDuration) %in% c("[    0,   61)",
                                               "[   61,  214)",
                                               "[  214,  366)",
                                               "[  366,  732)",
                                               "[  732,33787]"))){
...
```{r ModelOutput}
CompleteModel<-subset(CompleteContracts, 
...
write.table(CompleteModel
            ,file=paste("LargeDataSets\\defense_contract_CSIScontractID_model.csv"
                        ,sep=""
                        )
            #   ,header=TRUE
            , sep=","
...
CompleteModelAndDetail<-subset(CompleteModelAndDetail,select=c(CSIScontractID,
    FxCb,
    Fee,
    IDV,
    Comp,
    ...
    pChangeOrderObligated, #Probably don't need this
    pNewWorkUnmodifiedBaseAndAll,
    pNewWorkObligated, #Probably don't need this
    MinOfEffectiveDate,
    UnmodifiedCurrentCompletionDate,
    LastCurrentCompletionDate,
    IsClosed,
...
write.table(CompleteContracts
            ,file=paste("LargeDataSets\\defense_contract_CSIScontractID_detail.csv"
                        ,sep=""
                        )
            #   ,header=TRUE
            , sep=","
