...
#When
ggplot(data = subset(SiliconTopVendor,Customer=="Defense" & year(Fiscal.Year)<=2014),# subset(ContractSurvival,StartFiscalYear>=2007 & StartFiscalYear<=2013),
       aes(x=Fiscal.Year,
           y=Action.Obligation
#            ,
#            fill=ParentID
...
#                 , space="free_y"#But only because the space is free)+
    ...
    scale_y_continuous("Obligations (2014 Dollars)",labels=comma)
