...
CompleteModelAndDetail$UnmodifiedYears<-difftime(CompleteModelAndDetail$UnmodifiedCompletionDate,
...
```{r AnnualTerminationRateAggregate}
...
ggplot(TerminatedDurStat,aes(x=StartFiscalYear,y=mean,color=metric))+
    geom_line()+
    geom_point()+
    facet_grid(.~ Dur ) +
...
```{r AnnualTerminationRateByCeiling}
